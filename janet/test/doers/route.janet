...
(deftest "route-resources"
  ...
  (route/ensure "203.0.113.0/24" :gateway "127.0.0.1" :type "blackhole")
...
(deftest "route-error"
  ...
  (test-error
    (route/ensure "192.168.1.1"
                  :gateway "default"
                  :default "1.1.1.1")
    "unexpected property :default. Valid properties are :type, :interface, :force-gateway, :label, :flags, :gateway"))
