...
(deftest publisher-error
  ...
  (test-error
    (publisher/ensure "sysdef"
      :uri "http://pkg.lan.id264.net"
      :type "gibbus")
    "In publisher/ensure sysdef: :type must be one of \"origin\", \"mirror\" [got 'gibbus']")

  (test-error
    (publisher/ensure "sysdef")
    "In publisher/ensure sysdef: did not find mandatory property :uri. Mandatory properties are :uri, :type"))
