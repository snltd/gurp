...
(defdoer "cron"
  :description "Manage cron jobs. Crontab entries are prefixed with a
  ...
  :defaults-ensure {:hour "*"
                    :minute "*"
                    :day-of-month "*"
                    :day-of-week "*"
                    :month-of-year "*"
                    :user "root"}
  :defaults-remove {:user "root"}

  :notes ["Like other config management tools, Gurp precedes managed lines in the
