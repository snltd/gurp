...
// There's no misc/remove, only misc/ensure

const SHARECTL_CMD: &str = "/usr/sbin/sharectl";
...
impl GurpMisc {
    ...
    fn ensure_nfs_domain(
        ...
        let mut get_cmd = Command::new(SHARECTL_CMD);
        get_cmd
            .arg("get")
            .arg("-p")
            .arg("nfsmapid_domain")
        ...
        let mut set_cmd = Command::new(SHARECTL_CMD);
        set_cmd
            .arg("set")
            .arg("-p")
